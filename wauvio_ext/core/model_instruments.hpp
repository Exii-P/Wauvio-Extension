...
public:
    ...
    // Read-only access to the underlying per-note mapping, for callers
    // (e.g. the genre preset system) that need to inspect or style
    // individual mapped voices rather than just play them.
